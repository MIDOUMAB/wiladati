      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 28 }}>
        <View className="px-5 py-6">
          ...
          >
            ...
            >
              {t("pendantAccouchement.massageRelaxation.title")}
            </Text>
          </View>

          {/* Description */}
          <Text className={`text-base text-gray-700 mb-6 ${textAlign}`}>
            {t("pendantAccouchement.massageRelaxation.description")}
          </Text>
          ...
          <View className={`space-y-2 mb-6 ${pad2}`}>
            ...
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("pendantAccouchement.massageRelaxation.techniques.0")}
            </Text>
            <View className="flex-1 items-center h-50 my-4">
              <Image
                source={images.massageRelax}
                resizeMode="contain"
            ...
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("pendantAccouchement.massageRelaxation.techniques.1")}
            </Text>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("pendantAccouchement.massageRelaxation.techniques.2")}
            </Text>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("pendantAccouchement.massageRelaxation.techniques.3")}
            </Text>
            <View className="flex-1 items-center h-50 my-4">
              <Image
                source={images.brose}
...
export default MassageRelaxation;
