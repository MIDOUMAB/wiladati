      ...
      <ScrollView>
        <View className="px-5 py-6">
          ...
          >
            ...
            >
              {t("apresAccouchement.conseilsNourrisson.premieresHeures.0")}
            </Text>
          </View>
          ...
          <View className={`space-y-2 mb-6 ${pad2}`}>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.premieresHeures.1")}
            </Text>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.premieresHeures.2")}
            </Text>
            <View className="flex-1 items-center h-75 my-4">
              <Image
                source={images.vernix}
                resizeMode="contain"
            ...
            <Text className={`text-base text-gray-600 ${textAlign}`}>
              {"\u25E6"}{" "}
              {t("apresAccouchement.conseilsNourrisson.premieresHeures.3")}
            </Text>
          </View>
        </View>
      </ScrollView>
