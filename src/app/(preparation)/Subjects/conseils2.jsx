      ...
      <ScrollView>
        <View className="px-5 py-6">
          ...
          >
            ...
            >
              {t("apresAccouchement.conseilsNourrisson.soinsCordonOmbilical.0")}
            </Text>
          </View>
          ...
          <View className={`space-y-2 mb-6 ${pad2}`}>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.soinsCordonOmbilical.1")}
            </Text>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.soinsCordonOmbilical.2")}
            </Text>
            ...
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.soinsCordonOmbilical.3")}
            </Text>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.soinsCordonOmbilical.4")}
            </Text>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.soinsCordonOmbilical.5")}
            </Text>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.soinsCordonOmbilical.6")}
            </Text>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.soinsCordonOmbilical.7")}
            </Text>
            <Text className={`text-base text-gray-700 ${textAlign}`}>
              {"\u2022"}{" "}
              {t("apresAccouchement.conseilsNourrisson.soinsCordonOmbilical.8")}
            </Text>
          </View>
          <View className="flex-1 items-center h-75 my-4">
            <Image
